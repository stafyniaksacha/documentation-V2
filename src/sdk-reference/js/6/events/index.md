...
`@param {object} request`: the discarded [request]({{ site_base_path }}guide/1/essentials/request-and-response-format/)
...
`@param {object} request`: the [request]({{ site_base_path }}guide/1/essentials/request-and-response-format/) removed from the queue
...
| Property   | Type    | Description       |
| ---------- | ------- | ----------------- |
| `request` | <pre>object</pre> | [Request]({{ site_base_path }}guide/1/essentials/request-and-response-format/) added to the queue |
...
| Property   | Type    | Description       |
| ---------- | ------- | ----------------- |
| `request` | <pre>object</pre> | [Request]({{ site_base_path }}guide/1/essentials/request-and-response-format/) that is causing an error |
