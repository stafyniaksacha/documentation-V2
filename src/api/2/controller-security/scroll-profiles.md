...
This method moves a result set cursor forward, created by a [`searchProfiles` query]({{ site_base_path }}api/2/controller-security/search-profiles) with the `scroll` argument provided.
